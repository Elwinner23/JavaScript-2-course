...
})({"4Wa1R":[function(require,module,exports) {
...
parcelHelpers.export(exports, "cardValidator", ()=>cardValidator);
...
function callErrors(cardnumber) {
    if (cardnumber === undefined) throw new RangeError("You must enter a parameter!");
}
function reverseNumAndNumOperations(cardnumber) {
    ...
    let numOperations = numReverse.map((num, i)=>{
        if (i % 2 === 1) return num * 2 <= 9 ? num * 2 : num * 2 - 9;
        else return num;
    });
...
},{}]},["4Wa1R","bB7Pu"], "bB7Pu", "parcelRequire94c2")
