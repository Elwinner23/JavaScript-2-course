...
var CardInfo = require('card-info')
  ...
  describe('._banks', function () {
    if (typeof window === 'undefined') {
      it('should be same as banks in banks directory', function () {
        var banksWithPrefixes = require('card-info/tasks/_read-banks')()
        var banksAndPrefixes = require('card-info/tasks/_get-banks-and-prefixes')(banksWithPrefixes)
