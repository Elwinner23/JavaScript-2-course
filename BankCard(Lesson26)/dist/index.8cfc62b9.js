...
})({"cJKPX":[function(require,module,exports) {
...
function validInput() {
    ...
    let img = new URL(require("a4d08d25d9361e13"));
...
function invalidInput() {
    ...
    var content = require("83b21bec0f96a436");
    ...
    cardNum.addEventListener("input", (e)=>{
        ...
        if (content.getCreditCardNameByNumber(cardNum.value) == "Credit card is invalid!") cardNum.reportValidity();
    });
    cvvCode.addEventListener("input", (e)=>{
        const inputText = e.target.value.replaceAll(" ", "").replace(/\D/g, "");
        e.target.value = inputText.trim();
        if (content.isSecurityCodeValid(cardNum.value, cvvCode.value) == false) cvvCode.reportValidity();
    });
    date.addEventListener("input", (e)=>{
        const inputText = e.target.value.replaceAll(" ", "").replace(/\D/g, "");
        const formattedText = inputText.replace(/(.{2})/g, "$1/");
        e.target.value = formattedText.trim();
        if (!content.isExpirationDateValid(date.value.slice(0, 2), date.value.slice(3, 5))) date.reportValidity();
    });
    fullName.addEventListener("input", (e)=>{
        const inputText = e.target.value.replace(/\d/g, "").replace(/[А-Яа-я]/g, "").toUpperCase();
        e.target.value = inputText;
        if (!fullName.value) fullName.reportValidity();
    });
    if (!fullName.value) fullName.reportValidity();
    else validFullName = true;
    if (!content.isExpirationDateValid(date.value.slice(0, 2), date.value.slice(3, 5))) date.reportValidity();
    else validDate = true;
    if (content.isSecurityCodeValid(cardNum.value, cvvCode.value) == false) {
        if (content.getCreditCardNameByNumber(cardNum.value) == "Credit card is invalid!") cardNum.reportValidity();
        else validCardNum = true;
    } else validCvvCode = true;
    if (content.getCreditCardNameByNumber(cardNum.value) == "Credit card is invalid!") cardNum.reportValidity();
    else validCardNum = true;
    let countValids = 0;
    let valids = [
    ...
    valids.forEach((element)=>{
        if (element == false) countValids++;
    });
    let image = document.getElementById("image1");
    let image__cont = document.getElementsByClassName("images__container")[0];
    console.log(image__cont);
    let img1 = new URL(require("1926d78c0572ee1a"));
    let img2 = new URL(require("78f95115a1e6c524"));
    let img3 = new URL(require("4597e4f416b3228"));
    let img4 = new URL(require("5129344b506b128f"));
    switch(countValids){
        case 1:
...
},{"83b21bec0f96a436":"lyHGp","1926d78c0572ee1a":"5NEI5","78f95115a1e6c524":"5AlGA","4597e4f416b3228":"1UWBy","5129344b506b128f":"4z5kc","a4d08d25d9361e13":"ezBWs"}],"lyHGp":[function(require,module,exports) {
/**
...
},{}],"5NEI5":[function(require,module,exports) {
module.exports = require("29246394d11681a5").getBundleURL("fqV6O") + "ok.fd0a9d1c.jpg" + "?" + Date.now();

},{"29246394d11681a5":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"5AlGA":[function(require,module,exports) {
module.exports = require("8c1afbef0e4d09dd").getBundleURL("fqV6O") + "bad.9c580a0b.jpg" + "?" + Date.now();

},{"8c1afbef0e4d09dd":"lgJ39"}],"1UWBy":[function(require,module,exports) {
module.exports = require("8622fa1c0995083f").getBundleURL("fqV6O") + "VeryBad.bca7d4e4.jpg" + "?" + Date.now();

},{"8622fa1c0995083f":"lgJ39"}],"4z5kc":[function(require,module,exports) {
module.exports = require("24bd0623d479a0eb").getBundleURL("fqV6O") + "extBad.3ae17d09.jpg" + "?" + Date.now();

},{"24bd0623d479a0eb":"lgJ39"}],"ezBWs":[function(require,module,exports) {
module.exports = require("f24f6793b9ea4727").getBundleURL("fqV6O") + "great.85f40194.jpg" + "?" + Date.now();

},{"f24f6793b9ea4727":"lgJ39"}]},["cJKPX","6rimH"], "6rimH", "parcelRequiref3ad")
