...
document.getElementById("numb").addEventListener("focusout", function() {
    ...
    if (parseInt(number.substring(0, 2)) > 50 && parseInt(number.substring(0, 2)) < 56) selected_card = 0;
    else if (parseInt(number.substring(0, 1)) == 2) {
        selected_card = 1;
        console.log("visa");
    } else if (parseInt(number.substring(0, 2)) == 36 || parseInt(number.substring(0, 2)) == 38 || parseInt(number.substring(0, 2)) == 39) selected_card = 2;
    else if (parseInt(number.substring(0, 2)) == 34 || parseInt(number.substring(0, 2)) == 37) selected_card = 3;
    else if (parseInt(number.substring(0, 2)) == 65) selected_card = 4;
    else if (parseInt(number.substring(0, 4)) == 5019) selected_card = 5;
    ...
    } else document.getElementById("bankid").src += "".hide();
});

//# sourceMappingURL=card.5f39e005.js.map
