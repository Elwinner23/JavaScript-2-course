...
})({"8mnWE":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "5e93a7a29dc55de8";
"use strict";
...
function proverka() {
    ...
    if ((0, _cardValidatorUtils.validateCreditCardNumber)(card_number.value.replace(/\s/g, "")) && card_number.value.replace(/\s/g, "").length >= 14 && (0, _cardValidatorUtils.validateExpirationDate)(card_date.value.slice(0, 2), "20" + card_date.value.slice(3, 5)) && (0, _cardValidatorUtils.validateCVVORCVCCode)(card_cvc.value) && card_name.value.length >= 5) {
...
},{"card-validator-utils":"ea7rk"}],"ea7rk":[function(require,module,exports) {
...
},{}]},["8mnWE","klnXm"], "klnXm", "parcelRequire3423")

//# sourceMappingURL=card.9dc55de8.js.map
